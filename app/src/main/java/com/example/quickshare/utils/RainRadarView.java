...
public class RainRadarView extends View {
    //默认的主题颜色
    ...
    public RainRadarView(Context context) {
        super(context);
        init();
    }

    public RainRadarView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        getAttrs(context, attrs);
        init();
    }

    public RainRadarView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private static class Raindrop {
        ...
        public int changeAlpha() {
            return RainRadarView.changeAlpha(color, (int) alpha);
        }
